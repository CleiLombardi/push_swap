...
#    Updated: 2026/04/03 22:28:53 by roblomba         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = find_min_find_max_pos.c free_stack.c moves_1.c moves_2.c pa_pb.c \
 parsing_and_error.c position_and_target.c ra_rb_rr.c rra_rrb_rrr.c \
 sa_sb_ss.c sort_small.c sort_turk.c stack_nodes_utils.c main.c
